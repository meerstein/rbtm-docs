...
Чтобы отфильтровать результаты, необходимо ввести параметры поиска в поля и нажать кнопку “Поиск”. (скриншот)
...
Если вам известно название образца, вы можете осуществить поиск по нему. (скриншот)

**Вкладки DATA, DARK, EMPTY**

Для того, чтобы настроить параметры для каждого из конкретных этапов эксперимента, нажмите на соответствующую кнопку. Для каждого параметра можно задать значения "от" и "до" в соответствующих единицах измерения. (скриншоты)

Страница эксперимента
"""""""""""""""""""""

Вверху страницы отображены основные параметры эксперимента. (скриншот)
Внизу страницы расположен список всех изображений эксперимента. (скриншот)
Сообщение в середине экрана (добавить скриншоты) отображает состояние загрузки изображений. (скриншот)
Как только изображения загружены, можно нажать на номер любого изображения и открыть его.
Над изображением располагается основная информация об изображении.
