...
! Название функции, судя по коду create_user().
! отвечает на запрос @app.route('/storage/users/post', methods=['POST'])
! Вот так и опишите функуии. Вы пишете документацию для ращработчиков, а не для пользователей...
